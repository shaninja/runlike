...
This is very much a work in progress. Many `docker run` option-states are not yet proven supported. Feel free to send pull requests if you add support or fix bugs.
...
Support status is generated from round-trip probe results and the checked-in option dictionary:

- Markdown matrix: [`generated/support-matrix.md`](generated/support-matrix.md)
- Machine-readable matrix: [`generated/support-matrix.json`](generated/support-matrix.json)
